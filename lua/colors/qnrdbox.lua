...
local qnrd_theme = lush( function(injected_functions)
	...
	return {
		...
		SignColumn						{ fg = Q.Active.Border.Fg, bg = Q.Active.Border.Bg, gui = Q.Active.Border.Gui },
		...
		TroubleSignHint					{ fg = Colors.mint,			bg = Q.Active.Border.Bg,			gui = NoFmt },
		...
		DiagnosticHint					{ fg = Colors.mint,			bg = Q.Active.Bg,			gui = NoFmt },
		...
		DiagnosticFloatingHint			{ fg = Colors.mint,			bg = Q.Active.Bg,			gui = NoFmt },
		...
		DiagnosticSignHint				{ fg = Colors.mint,			bg = Q.Active.Border.Bg,			gui = NoFmt },
		...
		sym('@attribute')				{ fg = Q.Conditional.Fg,	bg = Q.Conditional.Bg,		gui = Q.Conditional.Gui },
		...
		DapUIBreakpointsCurrentLine		{ fg = Colors.crimson,			bg = NoFmt,					gui = FontMods.BU },
		DapUIBreakpointsLine			{ fg = Colors.crimson,			bg = NoFmt,					gui = FontMods.BI },
		...
		DapUIBreakpointsPath			{ fg = Colors.mocha,			bg = NoFmt},
		DapUIDecoration					{ fg = Colors.cloud,			bg = NoFmt},
		DapUIFrameName					{ fg = Colors.dust,				bg = NoFmt},
		DapUICurrentFrameName			{ fg = Colors.ripe_lemon,		bg = NoFmt},
		DapUISource						{ fg = Colors.mocha,			bg = NoFmt},
		DapUILineNumber					{ fg = Colors.matte_sapphire,	bg = NoFmt},
